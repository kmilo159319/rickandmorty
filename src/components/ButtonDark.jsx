...
export const ButtonDark = (props) => {
  ...
  return (
    ...
    <ButtonDarkStyled.Label mod={changeMod} for="darkmode-toggle">
	...
	</ButtonDarkStyled.Svg>
	<ButtonDarkStyled.Svg version="1.1" className="moon" viewBox="0 0 49.739 49.739">
